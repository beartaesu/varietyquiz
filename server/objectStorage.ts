...
export class ObjectStorageService {
  ...
  async uploadImageFromUrl(imageUrl: string, fileName: string): Promise<string> {
    try {
      ...
      const uploadPath = `${searchPaths[0]}/celebrity-images/${fileName}`;
      ...
      console.log(`📤 Uploading to object storage: ${objectName}`);
      ...
      return `/public-objects/celebrity-images/${fileName}`;
    } catch (error) {
